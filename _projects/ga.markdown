...
description: "Turning a complex animation tool into an intuitive experience for first-time users and supporting growing product complexity."
...
<div class="full-width-section" style="background-color: #EDEFF2; padding: 4rem 0;">
  <div class="container">
    ...
    <p>I joined Vyond in the Hong Kong office in the early days when the company was approaching product-market fit. Our team was lean — 3 designers among approx. 30 employees. We were deeply hands-on and cross-functional, working closely with colleagues in Taiwan and San Francisco.</p>
    <p>During this period, I helped lay the groundwork for scalable product design as the company doubled in size annually. Key contributions included:</p>
    <ul>
...
<div class="full-width-section" style="background-color: #fff; padding: 4rem 0;">
  <div class="container">
    <h3 class="page-label mb-3">Process & Approach</h3>
    <p>The goal was a unified interaction model that scaled across skill levels — from first-time users to power users. We applied a Double Diamond framework to move from ambiguity to clarity.</p>
    <h4>1. Discover: Research & Audits</h4>
    <ul>
      <li>Identified <strong>three key user personas</strong> with distinct goals to prioritise usability improvements and define content structure.</li>
...
<div class="full-width-section" style="background-color: #EDEFF2; padding: 4rem 0;">
  <div class="container">
    <h3 class="page-label mb-3">Example: Pattern in Action</h3>
    <p>Design pattern in action, demonstrating how users browse, apply, save, and reuse colours (26s).</p>
...
<div class="full-width-section" style="background-color: #fff; padding: 4rem 0;">
  <div class="container">
    ...
    <p>One of the toughest challenges was advocating for architectural change late in the development cycle. Rethinking structure mid-cycle isn't glamorous — but aligning stakeholders around tighter constraints ultimately gave the team the clarity to solve deeper user problems.</p>
  </div>
</div>
